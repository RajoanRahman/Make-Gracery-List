...
import com.example.rifat.grocerylistitem.UI.RecyclerViewAdapter;
...
public class ListActivity extends AppCompatActivity {
    ...
    private void createPopDialog() {
        ...
        groceryItem = (EditText) view.findViewById(R.id.grocery_item_editText);
        quantity = (EditText) view.findViewById(R.id.grocery_quantity_editText);
        saveButton = (Button) view.findViewById(R.id.save_buton);
