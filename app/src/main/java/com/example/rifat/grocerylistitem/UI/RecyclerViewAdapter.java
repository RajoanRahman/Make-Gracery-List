package com.example.rifat.grocerylistitem.UI;
...
import com.example.rifat.grocerylistitem.Activity.DetailsActivity;
...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void deleteItem(final int id) {
            ...
            View view = inflater.inflate(R.layout.confirmation_dialogu, null);
        ...
        public void editItem(final Grocery grocery) {
            ...
            final EditText groceryItem = (EditText) view.findViewById(R.id.grocery_item_editText);
            final EditText quantity = (EditText) view.findViewById(R.id.grocery_quantity_editText);
            final TextView title = (TextView) view.findViewById(R.id.tittle);

            title.setText("Edit Grocery");
            Button saveButton = (Button) view.findViewById(R.id.save_buton);
